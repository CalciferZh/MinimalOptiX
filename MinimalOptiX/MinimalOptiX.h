...
public:
  enum SceneId { SCENE_BASIC_TEST, SCENE_MESH_TEST, SCENE_COFFEE, SCENE_BEDROOM, SCENE_DININGROOM, SCENE_STORMTROOPER, SCENE_SPACESHIP, SCENE_CORNELL, SCENE_HYPERION };
  ...
  // attributes
  SceneId scendId = SCENE_HYPERION;
